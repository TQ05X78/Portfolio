...
|---|---|---|
|[Sales_RFM_Analysis](https://github.com/TQ05X78/Sales-RFM---Analysis) | Developed an interactive Sales-RFM Dashboard in Power BI. The RFM dashboard shows who bought what, it shows who your best customers are and who might churn, and where to focus your marketing campaigns.|  Data Modeling, Data Visualization, Created DAX KPI'S|
