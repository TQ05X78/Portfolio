...
|---|---|---|
| 🛍️ [Sales_RFM_Analysis](https://github.com/TQ05X78/Sales-RFM---Analysis) | Developed an interactive Sales-RFM Dashboard in Power BI. The RFM dashboard shows who bought what, it shows who your best customers are and who might churn, and where to focus your marketing campaigns.|  Data Modeling, Data Visualization, Created DAX KPI'S|
| 🦺 [Insurance Premium Analysis](https://github.com/TQ05X78/Insurance_Premium_Policy_Analysis) | Developed an interactive Insurance Premium Analysis Dashboard in Power BI. The dashboard includes track premium collections, Monitor maturity amount, Major KPI'S, customer retension trends and interactive slicers for dynamic analysis.| Data Cleaning using Power Query, Data Modeling, Data Visualization, Created DAX KPI'S|
